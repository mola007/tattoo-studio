...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__temp_scripts_modernizr__ = __webpack_require__(8);
...
(function (window, document, undefined) {
  ...
  Modernizr.addTest('cssgrid', testAllProps('grid-template-rows', 'none', true)); // Run each test
